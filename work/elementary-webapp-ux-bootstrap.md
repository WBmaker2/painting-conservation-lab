...
- Generated: `2026-09-23T11:01:19+00:00`
- Project: `/Volumes/ External Drive 256G/Dev2/codex/painting-conservation-lab`
- Mode: `full`
...
| node | yes | available | /opt/homebrew/bin/node | Run a JavaScript educational app. |
| npm | yes | available | /opt/homebrew/bin/npm | Use an npm lockfile and project scripts. |
| npx | yes | available | /opt/homebrew/bin/npx | Run the Playwright CLI wrapper when no in-app browser is available. |
